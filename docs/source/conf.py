...
# }
#
# html_theme_options = {"logo": "logo-text.png"}
...
extlinks = {
    ...
    "cement": (
        "http://builtoncement.com/{}/{}.html".format(VERSION, "%s"),
        "Cement Doc: ",
    ),
}
...
project = "Cement"
copyright = "2009-2019, Data Folk Labs, LLC"
...
html_short_title = "Cement Framework v%s" % RELEASE
...
latex_documents = [
    ("index", "Cement.tex", "Cement Framework", "Data Folk Labs, LLC", "manual")
]
...
man_pages = [("index", "cement", "Cement Framework", ["Data Folk Labs, LLC"], 1)]
